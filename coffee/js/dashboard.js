...
function initDashboard() {
  ...
  fetch("dashboard/sales_trend.json")
  ...
  fetch("dashboard/products_sold_by_category.json")
    .then((response) => response.json())
    .then((data) => {
  ...
  fetch("dashboard/sales_trend_by_category_week.json")
    .then((response) => response.json())
    .then((data) => {
...
$(document).ready(function () {
  $("#productSoldTable").DataTable({
    responsive: true,
    ajax: {
      url: "dashboard/products_sold_table.json",
      dataSrc: "",
    },
    columns: [
      { data: "store_location" },
